...
%token RETURN_TOKEN INT_TOKEN BOOL_TOKEN REAL_TOKEN CHAR_TOKEN STRING_TOKEN ARRAY_TOKEN RECORD_TOKEN RANGE_TOKEN SET_TOKEN BOOLLITERAL_TOKEN
...
%token REALLITERAL_TOKEN STRINGLITERAL_TOKEN SUBRANGELITERAL_TOKEN ID_TOKEN REF_TOKEN
