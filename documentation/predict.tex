...
& LITERAL & \{`intliteral',`boolliteral', `realliteral', `charliteral', `stringliteral', `subrangeliteral'\}\\ \cline{2-3}
& `(' EXPR `)' & \{`('\}\\
\hline
...
\hline
\multirow{2}{*}{NEG} & MUL & \{`id', `(', `intliteral', `boolliteral', `realliteral', `charliteral', `stringliteral', `subrangeliteral'\} \\
\cline{2-3}
& '!' MUL & \{`!'\} \\
\hline
...
& `$>=$' & \{`$>=$'\} \\
\hline
\multirow{6}{*}{LITERAL} & `intliteral' & \{`intliteral'\} \\
\cline{2-3}
