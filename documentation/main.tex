...
\newcommand{\herdado}[1]{\textcolor{red}{#1}}
\newcommand{\sintetizado}[1]{\textcolor{blue}{#1}}
...
%\subtitle{Back-end do Compilador: análise de contexto}
\author{Grupo 3}
\date{\today}
...
\input{descendentes.tex}

\newpage
\chapter{Analisador Sintático Ascendente}
\input{ascendente.tex}
