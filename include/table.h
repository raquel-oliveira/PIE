...
void init_table() {
    ...
    table[{CASELIST, BOOLLITERAL_TOKEN}] = {LITERALLIST, ':', STMT, ';'};
    ...
    table[{LITERALLIST, BOOLLITERAL_TOKEN}] = {LITERAL, LITERALLISTPRIME};
    ...
    table[{EXPR, BOOLLITERAL_TOKEN}] = {CONJ, DISJ};
    ...
    table[{FINAL_TERM, BOOLLITERAL_TOKEN}] = {LITERAL};
    ...
    table[{CONJ, BOOLLITERAL_TOKEN}] = {COMP, CONJPRIME};
    ...
    table[{COMP, BOOLLITERAL_TOKEN}] = {RELATIONAL, COMPPRIME};
    ...
    table[{RELATIONAL, BOOLLITERAL_TOKEN}] = {SUM, RELATIONALPRIME};
    ...
    table[{SUM, BOOLLITERAL_TOKEN}] = {NEG, SUMPRIME};
    ...
    table[{NEG, BOOLLITERAL_TOKEN}] = {MUL};
    ...
    table[{MUL, BOOLLITERAL_TOKEN}] = {FINAL_TERM, MULPRIME};
    ...
    table[{LITERAL, BOOLLITERAL_TOKEN}] = {BOOLLITERAL_TOKEN};
    ...
    table[{EXPRLIST, BOOLLITERAL_TOKEN}] = {EXPRLISTPLUS};
    ...
    table[{EXPRLISTPLUS, BOOLLITERAL_TOKEN}] = {EXPR, EXPRLISTPLUSPRIME};
